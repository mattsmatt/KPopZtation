...
(
    ...
    CONSTRAINT [FK_Album_ToArtist] FOREIGN KEY (ArtistID) REFERENCES Artist(ArtistID) ON DELETE CASCADE ON UPDATE CASCADE
)
...
(
    ...
    [Qty] INT NOT NULL, 
    CONSTRAINT [FK_Cart_ToCustomer] FOREIGN KEY (CustomerID) REFERENCES Customer(CustomerID) ON DELETE CASCADE ON UPDATE CASCADE, 
    CONSTRAINT [FK_Cart_ToAlbum] FOREIGN KEY (AlbumID) REFERENCES Album(AlbumID) ON DELETE CASCADE ON UPDATE CASCADE, 
...
(
    ...
    [CustomerID] INT NOT NULL, 
    CONSTRAINT [FK_TransactionHeader_ToCustomer] FOREIGN KEY (CustomerID) REFERENCES Customer(CustomerID) ON DELETE CASCADE ON UPDATE CASCADE
)
...
(
    ...
    [AlbumID] INT NOT NULL, 
    [Qty] INT NOT NULL, 
    CONSTRAINT [FK_TransactionDetail_ToTransactionHeader] FOREIGN KEY (TransactionID) REFERENCES TransactionHeader(TransactionID) ON DELETE CASCADE ON UPDATE CASCADE, 
    CONSTRAINT [FK_TransactionDetail_ToAlbum] FOREIGN KEY (AlbumID) REFERENCES Album(AlbumID) ON DELETE CASCADE ON UPDATE CASCADE, 
